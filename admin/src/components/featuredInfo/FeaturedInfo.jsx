...
export default function FeaturedInfo() {
  ...
  useEffect(() => {
    const getIncome = async () => {
      try {
        ...
        // setIncome(res.data);
        // const totalIncomeThisMonth = res.data[0].total;
        // const totalIncomeLastMonth = res.data[1].total;
        // setPercentage(((totalIncomeThisMonth - totalIncomeLastMonth) * 100) / totalIncomeLastMonth);
  ...
  console.log("income", income, percentage)
  return (
